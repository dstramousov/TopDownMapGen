...
MIN_PLACES = 1
RECOMMENDED_MIN_PLACES = 8
MAX_PLACES = 16
MIN_PLACE_DISTANCE_TILES = 4
PLACE_RADIUS_TILES = 6
MAX_PLACE_OBJECT_DISTANCE_TILES = 18
...
PLACE_TYPES: tuple[dict[str, Any], ...] = (
    ...
    {
        "type": "blocked_road",
        "name_ru": "Заблокированная дорога",
        "role": "road_obstruction",
        "anchor_type": "car_wreck",
        "preferred_types": ["abandoned_cart", "warning_sign", "scrap_pile"],
        "tags": ["roadside", "obstruction", "traversal", "human_trace"],
        "danger_level": 0.5,
        "loot_level": 0.25,
        "story_role": "blocked_route",
        "encounter_type": "traversal_obstacle",
        "biome_tags": ["abandoned", "open_field"],
    },
    {
        "type": "swamp_crossing",
        "name_ru": "Болотная переправа",
        "role": "natural_crossing",
        "anchor_type": "wooden_bridge",
        "preferred_types": ["pit", "bush_thicket", "fallen_log"],
        "tags": ["swamp", "water", "crossing", "traversal"],
        "danger_level": 0.4,
        "loot_level": 0.2,
        "story_role": "wet_crossing",
        "encounter_type": "traversal_obstacle",
        "biome_tags": ["swamp", "forest", "wet"],
    },
    {
        "type": "ruined_camp",
        "name_ru": "Разбитый лагерь",
        "role": "camp_micro_location",
        "anchor_type": "field_tent",
        "preferred_types": ["dead_campfire", "abandoned_backpack", "medkit_cache"],
        "tags": ["camp", "story", "human_trace"],
        "danger_level": 0.35,
        "loot_level": 0.55,
        "story_role": "abandoned_camp_trace",
        "encounter_type": "camp_discovery",
        "biome_tags": ["forest", "abandoned"],
    },
    {
        "type": "small_loot_pocket",
        "name_ru": "Малый тайник",
        "role": "loot_micro_location",
        "anchor_type": "ammo_cache",
        "preferred_types": ["medkit_cache", "abandoned_backpack", "scrap_pile"],
        "tags": ["loot", "secret", "reward"],
        "danger_level": 0.2,
        "loot_level": 0.85,
        "story_role": "minor_reward_cache",
        "encounter_type": "guarded_loot",
        "biome_tags": ["abandoned"],
    },
    {
        "type": "ambush_clearing",
        "name_ru": "Поляна для засады",
        "role": "ambush_location",
        "anchor_type": "bush_thicket",
        "preferred_types": ["fallen_log", "stone_chunk", "big_dead_tree"],
        "tags": ["ambush", "clearing", "cover", "forest"],
        "danger_level": 0.7,
        "loot_level": 0.15,
        "story_role": "natural_ambush_spot",
        "encounter_type": "flank_attack",
        "biome_tags": ["forest", "open_field"],
    },
    {
        "type": "watchtower_area",
        "name_ru": "Зона вышки",
        "role": "high_ground_landmark",
        "anchor_type": "watchtower",
        "preferred_types": ["warning_sign", "ammo_cache", "stone_chunk"],
        "tags": ["high_ground", "tower", "landmark", "story"],
        "danger_level": 0.75,
        "loot_level": 0.35,
        "story_role": "lookout_point",
        "encounter_type": "high_ground_encounter",
        "biome_tags": ["ruins", "abandoned"],
    },
    {
        "type": "bunker_outer_area",
        "name_ru": "Внешняя зона бункера",
        "role": "defensive_site",
        "anchor_type": "buried_bunker_2x3",
        "preferred_types": ["stone_chunk", "rusted_barrel", "warning_sign"],
        "min_object_refs": 1,
        "tags": ["bunker", "defense", "outer_area", "human_trace"],
        "danger_level": 0.75,
        "loot_level": 0.35,
        "story_role": "bunker_approach",
        "encounter_type": "bunker_encounter",
        "biome_tags": ["ruins", "abandoned"],
    },
    {
        "type": "bunker_inner_area",
        "name_ru": "Внутренняя зона бункера",
        "role": "below_ground_site",
        "anchor_type": "buried_bunker_2x2",
        "preferred_types": ["ammo_cache", "medkit_cache", "scrap_pile"],
        "min_object_refs": 1,
        "tags": ["bunker", "below_floor", "defense", "interior"],
        "danger_level": 0.65,
        "loot_level": 0.5,
        "story_role": "bunker_interior",
        "encounter_type": "bunker_room",
        "biome_tags": ["underground", "abandoned"],
    },
    {
        "type": "secret_cache",
        "name_ru": "Секретный тайник",
        "role": "secret_reward_location",
        "anchor_type": "abandoned_backpack",
        "preferred_types": ["ammo_cache", "medkit_cache", "old_grave_marker"],
        "tags": ["secret", "loot", "story", "reward"],
        "danger_level": 0.25,
        "loot_level": 0.9,
        "story_role": "secret",
        "encounter_type": "secret_discovery",
        "biome_tags": ["forest", "abandoned"],
    },
    {
        "type": "dangerous_lowland",
        "name_ru": "Опасная низина",
        "role": "hazard_low_ground",
        "anchor_type": "pit",
        "preferred_types": ["bush_thicket", "warning_sign", "fallen_log"],
        "tags": ["danger", "low_ground", "hazard", "traversal"],
        "danger_level": 0.8,
        "loot_level": 0.2,
        "story_role": "hazardous_lowland",
        "encounter_type": "hazard_encounter",
        "biome_tags": ["swamp", "wet"],
    },
    {
        ...
        "tags": ["signal", "expedition_trace", "landmark", "story"],
        "danger_level": 0.35,
        "loot_level": 0.45,
    ...
    },
    {
        ...
        "tags": ["forest", "obstruction", "natural", "traversal"],
        "danger_level": 0.3,
        "loot_level": 0.15,
    ...
    {
        "type": "raised_platform_site",
        "name_ru": "Приподнятая руинная площадка",
        "role": "elevated_micro_location",
        "anchor_type": "ruin_platform",
        "preferred_types": ["stone_stairs", "stone_ramp", "stone_chunk"],
        "tags": ["ruins", "platform", "high_ground", "traversal"],
        "danger_level": 0.55,
        "loot_level": 0.35,
        "story_role": "elevated_ruin_platform",
        "encounter_type": "vertical_traversal",
        "biome_tags": ["ruins", "abandoned"],
    },
)
...
def _place_schema() -> dict[str, Any]:
    return {
        ...
        "recommended_min_places": RECOMMENDED_MIN_PLACES,
