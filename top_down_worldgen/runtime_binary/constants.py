...
class SectionType(IntEnum):
    ...
    START_GOAL = 30
    VEGETATION_TYPE_U8 = 31
    VEGETATION_HEIGHT_U8 = 32
    STRUCTURE_TYPE_U8 = 33
    STRUCTURE_MICRO_MASK_U16 = 34
    STRUCTURE_WALKWAY_MASK_U16 = 35
    STRUCTURE_PARAPET_MASK_U16 = 36
    STRUCTURE_CRENELLATION_MASK_U16 = 37
