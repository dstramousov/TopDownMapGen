...
MANIFEST_SCHEMA_VERSION = "generation-manifest-v51"
...
MAP_PACKAGE_MAP_SCHEMA_VERSION = "map-package-map-v22"
...
STRUCTURE_TOP_GEOMETRY_LAYER_SCHEMA_VERSION = "structure-top-geometry-layer-v2"
