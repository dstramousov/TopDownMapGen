...
MANIFEST_SCHEMA_VERSION = "generation-manifest-v53"
...
MAP_PACKAGE_MAP_SCHEMA_VERSION = "map-package-map-v24"
...
STRUCTURE_TOP_GEOMETRY_LAYER_SCHEMA_VERSION = "structure-top-geometry-layer-v4"
