...
MANIFEST_SCHEMA_VERSION = "generation-manifest-v57"
...
MAP_PACKAGE_MAP_SCHEMA_VERSION = "map-package-map-v28"
...
STRUCTURE_HEIGHT_LAYER_SCHEMA_VERSION = "structure-height-layer-v4"
STRUCTURE_TYPE_LAYER_SCHEMA_VERSION = "structure-type-layer-v1"
STRUCTURE_MICRO_GEOMETRY_LAYER_SCHEMA_VERSION = "structure-micro-geometry-layer-v11"
STRUCTURE_TOP_GEOMETRY_LAYER_SCHEMA_VERSION = "structure-top-geometry-layer-v6"
...
def build_manifest(
    *,
    ...
    schema_versions = {
        ...
        "structure_top_geometry_layer": STRUCTURE_TOP_GEOMETRY_LAYER_SCHEMA_VERSION,
