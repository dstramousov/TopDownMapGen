...
MANIFEST_SCHEMA_VERSION = "generation-manifest-v36"
...
VALIDATION_REPORT_SCHEMA_VERSION = "validation-report-v32"
...
MAP_PACKAGE_MAP_SCHEMA_VERSION = "map-package-map-v10"
