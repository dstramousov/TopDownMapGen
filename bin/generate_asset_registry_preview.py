...
def _normalize_entries(manifest: dict[str, Any]) -> list[RegistryEntry]:
...
def build_registry_report(profile_dir: Path) -> dict[str, Any]:
...
<body>
  ...
  <table>
    <thead>
      <tr><th>ID</th><th>Kind</th><th>Category</th><th>Layer</th><th>Size</th><th>Pivot</th><th>Sort anchor</th><th>Status</th><th>Path</th><th>Tags</th></tr>
    </thead>
    <tbody>
